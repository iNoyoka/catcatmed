...
function trans_hello(){
	...
	document.getElementById("BHELLO").innerHTML = "哈囉";
	function myFunction(){
...
function trans_nicetomeetyou(){
	...
	document.getElementById("BNICEMEET").innerHTML = "<div id = 'BNICE_A' class='elementInVisable'></div><div id = 'BNICE_B' class='elementInVisable'></div>";
...
function trans_agePage(){
	...
	var Binner;
	document.getElementById("BAGECAL").innerHTML = "<div id = 'BAGE_A' class='elementInVisable'></div><div id = 'BAGE_B' class='elementInVisable'></div>";
	if(catage>=60){
...
function trans_pregpage(){
	...
	document.getElementById("BPREGPAGE").innerHTML = "<div id = 'BPREGPAGE_A' class='elementInVisable'></div><div id = 'BPREGPAGE_B' class='elementInVisable'></div>";
...
function trans_specialfood(){
	...
	document.getElementById("ASPECIALFOOD").innerHTML = "<div id = 'ASPECIALFOOD_A' class='elementInVisable'></div><div id = 'ASPECIALFOOD_B' class='elementInVisable'></div>";
...
function trans_keepexpert(){
	var Ainner;
	var Binner;
	document.getElementById("EKEEPEXP").innerHTML = "<div id = 'EKEEPEXP_A' class='elementInVisable'></div><div id = 'EKEEPEXP_B' class='elementInVisable'></div>";
...
function trans_nutritionexpert(){
	var Ainner;
	var Binner;
	document.getElementById("ENUTRIEXP").innerHTML = "<div id = 'ENUTRIEXP_A' class='elementInVisable'></div><div id = 'ENUTRIEXP_B' class='elementInVisable'></div>";
...
function trans_addwei(){
	...
	document.getElementById("IAW").innerHTML = "<div id = 'IAW_A' class='elementInVisable'></div>";
...
function trans_overwei(){
	document.getElementById("ILW").innerHTML = "<div id = 'ILW_A' class='elementInVisable'></div>";
...
function showResult(){
	...
	document.getElementById("RESULT").innerHTML = "<div id = 'RESULT_A' class='elementInVisable'></div><div id = 'RESULT_B' class='elementInVisable'></div><div id = 'RESULT_C' class='elementInVisable'></div><div id = 'RESULT_D' class='elementInVisable'></div>";
