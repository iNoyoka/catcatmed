...
app.post('/usercenter_requestData',function(req,res,next){
	//
				...
				con.query(sql_product,function(err,result){
					if(err) throw err;
						...
						if(catType == "成貓" && !req.session.correctqnlist.select_icon.includes('I')){					
							req.session.productdetailinfo = AddObjToList(result.productCode,result.productName_ZH,result.productCompany_ZH,result.productCompany_EN,result.productOriginal,result.price,result.kcal,result.MeatLevel_total,result.DRY_protein,result.DRY_fat,result.DRY_carbohydrate,result.goodMeat,result.potentialAlergent,kcal,result.productIngredients,catWeight,result.immu,result.heart,result.hair,result.mehair,result.joint,result.stoma,result.urinary,result.mouth,result.lowalergent,result.protein,result.fat,result.fiber,42,27,30,10,5,0);
						}else if(catType == "成貓" && req.session.correctqnlist.select_icon.includes('I')){
							req.session.productdetailinfo = AddObjToList(result.productCode,result.productName_ZH,result.productCompany_ZH,result.productCompany_EN,result.productOriginal,result.price,result.kcal,result.MeatLevel_total,result.DRY_protein,result.DRY_fat,result.DRY_carbohydrate,result.goodMeat,result.potentialAlergent,kcal,result.productIngredients,catWeight,result.immu,result.heart,result.hair,result.mehair,result.joint,result.stoma,result.urinary,result.mouth,result.lowalergent,result.protein,result.fat,result.fiber,42,27,30,10,11.3,0);
						}else if(catType == "胖成貓"){
							req.session.productdetailinfo = AddObjToList(result.productCode,result.productName_ZH,result.productCompany_ZH,result.productCompany_EN,result.productOriginal,result.price,result.kcal,result.MeatLevel_total,result.DRY_protein,result.DRY_fat,result.DRY_carbohydrate,result.goodMeat,result.potentialAlergent,kcal,result.productIngredients,catWeight,result.immu,result.heart,result.hair,result.mehair,result.joint,result.stoma,result.urinary,result.mouth,result.lowalergent,result.protein,result.fat,result.fiber,42,27,20,9,15,6);
						}else if(catType == "幼貓"){
							req.session.productdetailinfo = AddObjToList(result.productCode,result.productName_ZH,result.productCompany_ZH,result.productCompany_EN,result.productOriginal,result.price,result.kcal,result.MeatLevel_total,result.DRY_protein,result.DRY_fat,result.DRY_carbohydrate,result.goodMeat,result.potentialAlergent,kcal,result.productIngredients,catWeight,result.immu,result.heart,result.hair,result.mehair,result.joint,result.stoma,result.urinary,result.mouth,result.lowalergent,result.protein,result.fat,result.fiber,50,35,35,18,35,0);
						}else if(catType == "懷孕貓"){
							req.session.productdetailinfo = AddObjToList(result.productCode,result.productName_ZH,result.productCompany_ZH,result.productCompany_EN,result.productOriginal,result.price,result.kcal,result.MeatLevel_total,result.DRY_protein,result.DRY_fat,result.DRY_carbohydrate,result.goodMeat,result.potentialAlergent,kcal,result.productIngredients,catWeight,result.immu,result.heart,result.hair,result.mehair,result.joint,result.stoma,result.urinary,result.mouth,result.lowalergent,result.protein,result.fat,result.fiber,50,35,35,18,35,0);
						}else if(catType == "泌乳貓"){
							req.session.productdetailinfo = AddObjToList(result.productCode,result.productName_ZH,result.productCompany_ZH,result.productCompany_EN,result.productOriginal,result.price,result.kcal,result.MeatLevel_total,result.DRY_protein,result.DRY_fat,result.DRY_carbohydrate,result.goodMeat,result.potentialAlergent,kcal,result.productIngredients,catWeight,result.immu,result.heart,result.hair,result.mehair,result.joint,result.stoma,result.urinary,result.mouth,result.lowalergent,result.protein,result.fat,result.fiber,50,35,35,18,35,0);
						}else if(catType == "交配貓"){
							req.session.productdetailinfo = AddObjToList(result.productCode,result.productName_ZH,result.productCompany_ZH,result.productCompany_EN,result.productOriginal,result.price,result.kcal,result.MeatLevel_total,result.DRY_protein,result.DRY_fat,result.DRY_carbohydrate,result.goodMeat,result.potentialAlergent,kcal,result.productIngredients,catWeight,result.immu,result.heart,result.hair,result.mehair,result.joint,result.stoma,result.urinary,result.mouth,result.lowalergent,result.protein,result.fat,result.fiber,42,27,25,9,35,0);
						}else if(catType == "老貓" && !req.session.correctqnlist.select_icon.includes('I')){
							req.session.productdetailinfo = AddObjToList(result.productCode,result.productName_ZH,result.productCompany_ZH,result.productCompany_EN,result.productOriginal,result.price,result.kcal,result.MeatLevel_total,result.DRY_protein,result.DRY_fat,result.DRY_carbohydrate,result.goodMeat,result.potentialAlergent,kcal,result.productIngredients,catWeight,result.immu,result.heart,result.hair,result.mehair,result.joint,result.stoma,result.urinary,result.mouth,result.lowalergent,result.protein,result.fat,result.fiber,42,27,22,16,4.5,0);
						}else if(catType == "老貓" && req.session.correctqnlist.select_icon.includes('I')){
							req.session.productdetailinfo = AddObjToList(result.productCode,result.productName_ZH,result.productCompany_ZH,result.productCompany_EN,result.productOriginal,result.price,result.kcal,result.MeatLevel_total,result.DRY_protein,result.DRY_fat,result.DRY_carbohydrate,result.goodMeat,result.potentialAlergent,kcal,result.productIngredients,catWeight,result.immu,result.heart,result.hair,result.mehair,result.joint,result.stoma,result.urinary,result.mouth,result.lowalergent,result.protein,result.fat,result.fiber,42,27,22,16,11.3,0);
						}else if(catType == "老老貓" || catType == "胖老老貓" || catType == "胖老貓"){
							req.session.productdetailinfo = AddObjToList(result.productCode,result.productName_ZH,result.productCompany_ZH,result.productCompany_EN,result.productOriginal,result.price,result.kcal,result.MeatLevel_total,result.DRY_protein,result.DRY_fat,result.DRY_carbohydrate,result.goodMeat,result.potentialAlergent,kcal,result.productIngredients,catWeight,result.immu,result.heart,result.hair,result.mehair,result.joint,result.stoma,result.urinary,result.mouth,result.lowalergent,result.protein,result.fat,result.fiber,42,27,16,9,15,4.5);
						}
